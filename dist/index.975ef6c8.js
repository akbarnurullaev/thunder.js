...
new _thunder.ThunderDOM({
    root: "#root"
}).render(_app.App);

},{"./Thunder":"iIa76","./app":"1l7bB"}],"iIa76":[function(require,module,exports) {
...
class Thunder {
    ...
    // this.#APPLY_EVENTS()
     ...
     #APPLY_STYLES() {
        ...
        for (const [key, value] of Object.entries(CSSObject))this.element.style[key] = value;
    }
    // #APPLY_EVENTS() {
    ...
    props(propsObject) {
        ...
        /* Call Props Init Hook */ this.#PROPS_INITIALIZED();
        /* Returning the whole HTML Element as a string */ return this.element.outerHTML;
    }
    template(literals, ...values) {
        let result1 = "", stylesProxy = null;
        if (!this.__TEMPLATE_CACHE__) this.__TEMPLATE_CACHE__ = {
            literals,
            values
        };
        if (this.__STORE__?.styles) stylesProxy = new Proxy(this.__STORE__.styles, {
            get (target, key) {
                const { camelToSnakeCase  } = ThunderUtils, result = [];
                for (const [property, value] of Object.entries(target[key]))result.push(`${camelToSnakeCase(property)}:${value}`);
                return result.join(";");
            }
        });
        ...
        for(let i = 0; i < TCacheLiterals.length; i++){
            /* Check for initial state */ if (i > 0) {
                ...
                /* Check passed value if that's function */ if (typeof target === "function") result1 += target({
                    store: {
                        ...this.__STORE__,
                ...
                else // Passing target value by default
                result1 += target;
            }
            /* Adding current literal */ result1 += TCacheLiterals[i];
        }
        /* Adding template into cache */ this.__TEMPLATE_CACHE__.template = result1.replace(/(\r\n|\n|\r)/gm, "").trim();
     ...
     #bindEvents() {
        for (const element of this.__ROOT_ELEMENT__.getElementsByTagName("*")){
            ...
            if (events.length > 0) events.forEach(({ name , body  })=>{
                element.addEventListener(name.replace(ThunderKeyWords.event, ""), (e)=>new Function(`return ${body}`)()(e)
                );
            });
        }
    }
...
const App = new _thunder.Thunder({
    tag: "main"
}).store(()=>{
    const events = {
        onHeadlineClick: ()=>{
    ...
    ${({ store  })=>_components.Headline.props({
        label: "ThunderJS Fucks",
        onClick: store.events.onHeadlineClick
    })
}

    ${({ store  })=>_components.Button.props({
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","../Thunder":"iIa76","../components":"6nkmk"}],"6nkmk":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "Headline", ()=>_headline.Headline
);
...
},{"./Headline":"ePcXz","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./Button":"bNbfl"}],"ePcXz":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "Headline", ()=>Headline
);
var _thunder = require("../../Thunder");
const Headline = new _thunder.Thunder({
    tag: "section"
}).style(()=>({
...
},{"../../Thunder":"iIa76","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"bNbfl":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "Button", ()=>Button
);
var _thunder = require("../../Thunder");
const Button = new _thunder.Thunder({
    tag: "button"
}).style((props)=>({
...
},{"../../Thunder":"iIa76","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["7nZVA","8lqZg"], "8lqZg", "parcelRequireb215")
